<?php
    ...
    */
    session_set_cookie_params(3600 * 3, $_SERVER["BASE"], "localhost", true, true); # 1 Godz / 2, zostawcie default na 1 godzine i po prostu matmy używajcie, np 3600 * 1.5 = 1godz 30min
    session_start();
